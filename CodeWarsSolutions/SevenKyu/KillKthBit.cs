/* URL: https://www.codewars.com/kata/simple-fun-number-8-kill-k-th-bit/train/csharp
Task
...
namespace CodeWarsSolutions.SevenKyu
{
    class KillKthBitClass
    {
        ...
        {
            return Convert.ToInt32(String.Concat(Convert.ToString(n, 2)
                .Select((x, i) => i == (Convert.ToString(n, 2).Length - k) ? '0' : x)), 2);
        }
    }
}
