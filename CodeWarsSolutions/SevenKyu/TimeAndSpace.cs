/* URL: https://www.codewars.com/kata/simple-fun-number-193-moment-of-time-in-space/train/csharp
...
namespace CodeWarsSolutions.SevenKyu
{
    public class TimeAndSpace
    {
        ...
        {
            var time = moment.Aggregate(0, (c, i) => (char.IsNumber(i) && i != '0') ? c + (int)char.GetNumericValue(i) : c);
            var space = moment.Aggregate(0, (c, i) => (char.IsNumber(i) && i != '0') ? c : ++c);
