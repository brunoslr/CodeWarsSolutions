/* Url: https://www.codewars.com/kata/simple-fun-number-187-does-fred-need-a-houseboat/train/csharp
...
{
    public class DoesFredNeedABoathouse
    {
        public int DoesFredNeedHouseboat(int x, int y)
        {
            double rd = 0, area = 0, dist = Math.Sqrt(x * x + y * y);
            int r = 0;
            while (rd < dist)
            {
