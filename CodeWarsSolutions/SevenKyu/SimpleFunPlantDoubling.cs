/* URL:https://www.codewars.com/kata/simple-fun-number-189-plant-doubling/train/csharp
...
{
    class SimpleFunPlantDoubling
    {
            public int PlantDoubling(int n) => Convert.ToString(n, 2).Count(c => c == '1'); 
    }
}
