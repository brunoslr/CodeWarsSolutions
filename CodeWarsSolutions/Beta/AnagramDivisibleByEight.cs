/* In this exercise you need to develop a method that checks if a given string value containing only numbers can be rearange in any way that their value would be divisible by 8.
