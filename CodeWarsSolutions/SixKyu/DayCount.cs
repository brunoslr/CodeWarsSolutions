/*URL:https://www.codewars.com/kata/count-the-days/train/csharp
...
namespace CodeWarsSolutions.SixKyu
{
    public class Day
    {
        public string countDays(DateTime d)
        {
            ...
            TimeSpan timeDiference = d.Date - DateTime.Today;

           return $"{(timeDiference.TotalDays == 0 ? "Today is the day!": timeDiference.TotalDays>0?timeDiference.TotalDays - 1 +" days":"The day is in the past!" )}";
