/* URL: https://www.codewars.com/kata/simple-fun-number-169-press-button/train/csharp
...
{
    public class PressButtonKata
    {
        public double PressButton(int n)
        {
