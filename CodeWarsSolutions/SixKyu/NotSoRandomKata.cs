/* URL: https://www.codewars.com/kata/simple-fun-number-158-not-so-random/train/csharp
...
{
    class NotSoRandomKata
    {
        public string NotSoRandom(double b, double w) => (b % 2 == 1) ? "Black" : "White";
    }
}
