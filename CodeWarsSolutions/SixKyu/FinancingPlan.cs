/* URL: https://www.codewars.com/kata/financing-plan-on-planet-xy140z-n/train/csharp
...
One line solution:  public static ulong finance(ulong n) => n * (n + 1) * (n + 2) / 2; 
 */
...
public class Finance
    {
        public static ulong finance(ulong n)
        {
            ...
            {
                var range = (int)n - i + 1;
                sum += (ulong)Enumerable.Range(2 * i, (int)n - i + 1).Sum();
            }
            return sum;
        }
    }
